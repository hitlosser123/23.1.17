...
#define CS_ICM_PORT       GPIO_PORTD_BASE
#define CS_ICM_IO         GPIO_PIN_7
#define CS_ICM_Peri_CLK   SYSCTL_PERIPH_GPIOD

#define ICM_Temp_Ctrl_PORT       GPIO_PORTE_BASE
#define ICM_Temp_Ctrl_IO         GPIO_PIN_2
#define ICM_Temp_Ctrl_CLK   		 SYSCTL_PERIPH_GPIOE
